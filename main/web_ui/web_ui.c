...
"        <span class='nav-label'>仪表盁E/span>"
"      </div>"
...
"            <span class='card-title'>系统状态E/span>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>快速操佁E/span>"
"          </div>"
"          <div class='form-row'>"
"            <button class='btn btn-primary' onclick='switchView(\"chat\")'>进�E聊天</button>"
"            <button class='btn btn-danger' onclick='reboot()'>重启设夁E/button>"
"          </div>"
"        </div>"
"      </div>"
"    </div>"
...
"            </select>"
"            <input type='text' id='chatInput' placeholder='发送消�E...' onkeypress='handleChatKey(event)'>"
"            <button onclick='sendChat()' id='sendBtn'>发送E/button>"
"          </div>"
"        </div>"
"      </div>"
"    </div>"
...
"            <button class='btn btn-sm btn-primary' onclick='saveAgent()'>保孁E/button>"
"          </div>"
"          <div class='form-group'>"
"            <label>SOUL.md (性格设宁E</label>"
...
"            <button class='btn btn-sm btn-primary' onclick='saveSettings()'>保孁E/button>"
"          </div>"
"          <div class='form-row'>"
"            <div class='form-group'>"
"              <label>提供商</label>"
...
"            <div class='form-group'>"
"              <label>默认模垁E/label>"
"              <input type='text' id='model' placeholder='妁E claude-opus-4-5'>"
"            </div>"
"          </div>"
"          <div class='form-row'>"
"            <div class='form-group'>"
...
"              <input type='text' id='ollama_host' placeholder='妁E 192.168.1.100'>"
"            </div>"
"            <div class='form-group'>"
...
"              <label for='streaming' style='margin:0'>启用流式输�E (Streaming)</label>"
"            </div>"
"          </div>"
"        </div>"
""
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>设夁E��佁E/span>"
"          </div>"
"          <button class='btn btn-danger' onclick='reboot()'>重启设夁E/button>"
"        </div>"
"      </div>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>设夁E��邦</span>"
"            <button class='btn btn-sm btn-primary' onclick='loadPeers()'>刷新列表</button>"
"          </div>"
"          <div id='peerList' style='font-size:13px;color:#ccc'>加载中...</div>"
"        </div>"
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>群绁E��播</span>"
"          </div>"
"          <div class='form-row'>"
...
"            <button class='btn btn-primary' onclick='sendBroadcast()'>发送E/button>"
"          </div>"
"        </div>"
"      </div>"
"    </div>"
...
"            <button class='btn btn-sm btn-primary' onclick='saveSearchKey()'>保孁E/button>"
"          </div>"
"          <div class='form-group'>"
"            <label>Brave Search API Key</label>"
"            <input type='password' id='searchKey' placeholder='BSA-xxxx...'>"
"          </div>"
"          <div style='font-size:12px;color:#888;margin-top:4px'>仁E<a href='https://brave.com/search/api/' style='color:#6C9BD2' target='_blank'>brave.com/search/api</a> 获取�E费 API Key</div>"
"        </div>"
""
"        <div class='card'>"
"          <div class='card-header'>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>工具状态E/span>"
"          </div>"
"          <div style='font-size:13px;color:#ccc;line-height:2'>"
"            <div>📅 <b>获取时间</b>�E�通迁ESNTP 自动同步�E�无需配置</div>"
"            <div>📁 <b>斁E��管琁E/b>�E�读 / 冁E/ 编辁E/ 列�E SPIFFS 斁E��</div>"
"          </div>"
"        </div>"
""
"      </div>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>引�E配置</span>"
"            <button class='btn btn-sm btn-primary' onclick='savePinConfig()'>保存�E置</button>"
"          </div>"
...
"            </div>"
"            <div>"
"              <div style='font-size:13px;color:var(--text-secondary);margin-bottom:4px;'>I2S0 WS (麦克飁E</div>"
...
"            </div>"
"            <div>"
"              <div style='font-size:13px;color:var(--text-secondary);margin-bottom:4px;'>I2S0 SCK (麦克飁E</div>"
...
"            </div>"
"            <div>"
"              <div style='font-size:13px;color:var(--text-secondary);margin-bottom:4px;'>I2S0 SD (麦克飁E</div>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>硬件状态E/span>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>I2C 设夁E��揁E/span>"
"            <button class='btn btn-sm btn-primary' onclick='scanI2C()'>扫揁E/button>"
"          </div>"
"          <div id='i2c-result' style='font-size:13px;color:#ccc'>点击扫揁E..</div>"
"        </div>"
""
"        <div class='card'>"
"          <div class='card-header'>"
...
"            <button id='hub-btn-installed' class='btn btn-sm' onclick='switchHubTab(\"installed\")'>已安裁E��琁E/button>"
"            <button id='hub-btn-sources' class='btn btn-sm' onclick='switchHubTab(\"sources\")'>MCP 溁E/button>"
"          </div>"
"        </div>"
...
"              <input type='text' id='skillSearch' placeholder='搜索传感器、舵机、LED...' style='flex:1;padding:12px 16px;border:1px solid var(--border);border-radius:8px;font-size:14px;' oninput='filterSkills()'>"
"              <span id='slotInfo' style='font-size:13px;color:var(--text-secondary);white-space:nowrap;'>已安裁E 0/0</span>"
"            </div>"
...
"          <div class='card'>"
"            <div class='card-header'>"
"              <span class='card-title'>已安裁E��能</span>"
"              <button class='btn btn-sm' onclick='reloadSkills()'>🚀 重载引擎</button>"
"            </div>"
"            <div id='installedList'>"
"              <div style='text-align:center;color:var(--text-secondary);padding:20px;'>暂无已安裁E��能</div>"
"            </div>"
"          </div>"
"        </div>"
...
"                <button class='btn btn-sm btn-primary' onclick='showAddMcpSourceModal()'>+ 添加溁E/button>"
"              </div>"
"              <button class='btn btn-sm' onclick='loadMcpSources()'>🔄 刷新</button>"
"            </div>"
...
"      const titles = { dashboard: '仪表盁E, chat: '聊天', agent: 'Agent', settings: '设置', tools: '工具', hardware: '硬件', skillhub: 'SkillHub', installed: '已安裁E��能', federation: '联邦' };\n"
...
"          { label: '模垁E, value: data.model || '未设置' },"
...
"        });"
"        document.getElementById('ipBadge').textContent = data.wifi_ip || '无网绁E;"
...
"      if (h > 0) return h + '小时 ' + (m % 60) + '刁E��';"
"      if (m > 0) return m + '刁E�� ' + (s % 60) + '私E;"
"      return s + '私E;"
"    }"
""
"    /* Settings */"
...
"        });"
"        if (resp.ok) { showToast('配置已保孁E, 'success'); }"
"        else { showToast('保存失败', 'error'); }"
"      } catch(e) { showToast('保存失败: ' + e, 'error'); }"
"    }"
""
"    async function reboot() {"
"      if (!confirm('确定要E��启设夁E���E�E)) return;"
"      try {"
...
""
"    function sendChat() {"
"      if (!connected) { showToast('未连接到设夁E, 'error'); return; }"
...
"      pendingTimer = setTimeout(function() { pending = 0; updateSendBtn(); addChatMessage('error', '响应趁E���E�请重证E); }, 300000);"
""
...
"          list.innerHTML = '<div style=\"padding:10px;text-align:center\">暂无发现其他设夁E/div>';"
"          return;"
"        }"
"        list.innerHTML = '';"
...
"        });"
"        if (resp.ok) { showToast('Agent 配置已保孁E, 'success'); }"
"        else { showToast('保存失败', 'error'); }"
"      } catch(e) { showToast('保存失败: ' + e, 'error'); }"
"    }"
""
...
"      if (!key) { showToast('请输�E API Key', 'error'); return; }"
"      try {"
"        const resp = await fetch('/api/tools/search_key', {"
"          method: 'POST',"
"          headers: {'Content-Type': 'application/json'},"
...
"        });"
"        if (resp.ok) { showToast('搜索 Key 已保孁E, 'success'); }"
"        else { showToast('保存失败', 'error'); }"
"      } catch(e) { showToast('保存失败: ' + e, 'error'); }"
"    }"
""
...
"          el.innerHTML = '<div style=\"color:#888\">没有活动皁E��时任务</div>';\n"
"          return;\n"
"        }\n"
"        let html = '';\n"
"        data.jobs.forEach(function(j) {\n"
"          var sched = j.kind === 'every' ? '毁E' + j.interval_s + ' 私E : '在 ' + new Date(j.at_epoch * 1000).toLocaleString();\n"
...
"          html += '<div><b>' + j.name + '</b><br><span style=\"font-size:11px;color:#888\">' + sched + ' | ' + (j.enabled ? '✁E启用' : '❁E禁用') + ' | ID: ' + j.id + '</span></div>';\n"
...
"           el.innerHTML = '<div style=\"grid-column:1/-1;text-align:center;color:#888;padding:20px\">暂无 MCP 溁E/div>';\n"
"           return;\n"
"        }\n"
"        let html = '';\n"
"        data.sources.forEach(s => {\n"
"           const statusColor = s.status === 'connected' ? 'var(--success)' : '#94a3b8';\n"
"           const statusText = s.status === 'connected' ? '已连接' : '未连接';\n"
"           html += `<div class='card'>`;\n"
...
"               html += `<button class='btn btn-sm btn-primary' onclick='mcpAction(${s.id}, \"connect\")'>连接</button>`;\n"
"           } else {\n"
"               html += `<button class='btn btn-sm' onclick='mcpAction(${s.id}, \"disconnect\")'>断开</button>`;\n"
"           }\n"
"           // html += `<button class='btn btn-sm btn-danger' onclick='deleteMcpSource(${s.id})'>删除</button>`; // TODO\n"
"           html += `  </div>`;\n"
"           html += `</div>`;\n"
"        });\n"
"        el.innerHTML = html;\n"
"      } catch(e) { document.getElementById('mcpSourceList').textContent = '加载失败: ' + e; }\n"
"    }\n"
""
""
...
"            });\n"
"            if (resp.ok) { showToast('操作�E劁E, 'success'); loadMcpSources(); }\n"
...
"             });\n"
"             if (resp.ok) { showToast('添加成功', 'success'); loadMcpSources(); }\n"
...
"      if (!confirm('确定删除任务 ' + id + ' 吗！E)) return;\n"
"      try {\n"
...
"        html += '<div style=\"grid-column:span 2;margin-top:8px;padding-top:8px;border-top:1px solid #eee;\"><strong>冁E��E</strong></div>';\n"
...
"        html += '<div><span style=\"color:#666\">冁E��:</span> ' + (data.free_heap_internal/1024).toFixed(1) + ' KB / ' + (data.total_heap_internal/1024).toFixed(0) + ' KB (' + intPct.toFixed(0) + '% used)</div>';\n"
...
"        html += '<div><span style=\"color:#666\">最大坁E</span> ' + (data.largest_free_block/1024).toFixed(1) + ' KB</div>';\n"
...
"        if (data.success) {\n"
"          st.textContent = '配置已保存，需要E��启生效';\n"
"          st.style.color = 'var(--success)';\n"
"          showToast('引�E配置已保孁E, 'success');\n"
"        } else {\n"
"          st.textContent = '保存失败';\n"
...
"        } else {\n"
"             if (isInstalled) {\n"
"                html += `      <button class='btn btn-sm' style='background:var(--success);color:white;opacity:0.8' disabled>已安裁E/button>`;\n"
"             } else {\n"
"                html += `      <button class='btn btn-sm btn-primary' onclick='installSkill(\"${escapeHtml(skill.name)}\", \"${escapeHtml(skill.url || '')}\")'>安裁E/button>`;\n"
"             }\n"
"             html += `      <button class='btn btn-sm' onclick='showSkillDetails(\"${escapeHtml(skill.name)}\")'>详惁E/button>`;\n"
"        }\n"
"        html += `    </div>`;\n"
"        html += `  </div>`;\n"
"        html += `</div>`;\n"
...
"      document.getElementById('slotInfo').textContent = `已安裁E ${count}/${MAX_SLOTS} 卡槽`;\n"
"    }\n"
""
""
"    async function installSkill(name, url) {\n"
"      if (!url) {\n"
"        showToast('该技能暂无可用安裁E��E, 'warning');\n"
"        return;\n"
"      }\n"
"      try {\n"
"        showToast('正在安裁E' + name + '...', 'success');\n"
...
"        const data = await resp.json();\n"
"        if (data.success) {\n"
"          showToast(name + ' 安裁E�E劁E', 'success');\n"
"          await loadSkills();\n"
"        } else {\n"
"          showToast('安裁E��败: ' + (data.error || '未知错误'), 'error');\n"
"        }\n"
"      } catch(e) {\n"
"        showToast('安裁E��求失败: ' + e.message, 'error');\n"
"      }\n"
"    }\n"
""
""
"    async function uninstallSkill(name) {\n"
"      if (!confirm('确定要卸载 ' + name + ' 吁E')) return;\n"
"      try {\n"
...
"      if (!confirm('确定要E��载技能引擎吁E')) return;\n"
"      try {\n"
...
"      if (skills.length === 0) {\n"
"        container.innerHTML = '<div style=\"text-align:center;color:var(--text-secondary);padding:20px;\">暂无已安裁E��能</div>';\n"
"        return;\n"
"      }\n"
""
""
...
"        const stateText = state === 'READY' ? '运行中' : (state === 'ERROR' ? '异常' : '已停止');\n"
"        const category = skill.category || 'UNKNOWN';\n"
"        const type = skill.type || 'TOOL';\n"
"        const bus = skill.bus || 'NONE';\n"
...
{
    /* Read each file  Euse PSRAM if available */
...
static esp_err_t firmware_update_handler(httpd_req_t *req)
{
    ...
    /* Start OTA in the current context  Ewill reboot on success */
...
esp_err_t web_ui_init(void)
{
    ...
    config.max_open_sockets = 3;  /* keep low  Eonly serves HTML/JSON */
