...
"        html += '<button id=\"btn-gpio-' + p + '-on\" class=\"btn btn-sm btn-success\" onclick=\"toggleGPIO(' + p + ', true)\" style=\"opacity:0.3\">ON</button>';\n"
"        html += '<button id=\"btn-gpio-' + p + '-off\" class=\"btn btn-sm btn-danger\" onclick=\"toggleGPIO(' + p + ', false)\" style=\"margin-left:4px;opacity:0.3\">OFF</button>';\n"
"        html += '</div>';\n"
"      });\n"
