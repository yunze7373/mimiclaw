...
/* ÑüÑü SPA HTML Page ÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑü */
...
"        <span class='nav-icon'>??</span>"
"        <span class='nav-label'>çdåè</span>"
"      </div>"
...
"        <span class='nav-icon'>??</span>"
"        <span class='nav-label'>?íu</span>"
"      </div>"
"      <div class='nav-item' data-view='tools'>"
"        <span class='nav-icon'>??</span>"
"        <span class='nav-label'>çHãÔ</span>"
"      </div>"
"      <div class='nav-item' data-view='federation'>"
"        <span class='nav-icon'>??</span>"
"        <span class='nav-label'>?ñM</span>"
"      </div>"
...
"  <div class='main'>"
"    <div class='header'>"
"      <h1 id='pageTitle'>?ï\?</h1>"
"      <div class='header-right'>"
"        <span class='ip-badge' id='ipBadge'>?éÊIP...</span>"
"      </div>"
"    </div>"
""
"    <!-- Dashboard View -->"
...
"            <span class='card-title'>ån?èÛ?</span>"
"            <button class='btn btn-sm btn-primary' onclick='refreshStatus()'>ç¸êV</button>"
"          </div>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>âıë¨ëÄçÏ</span>"
"          </div>"
"          <div class='form-row'>"
"            <button class='btn btn-primary' onclick='switchView(\"chat\")'>?ì¸„÷ìV</button>"
"            <button class='btn btn-danger' onclick='reboot()'>èd???</button>"
"          </div>"
"        </div>"
"      </div>"
"    </div>"
...
"            </select>"
"            <input type='text' id='chatInput' placeholder='?ëóè¡ëß...' onkeypress='handleChatKey(event)'>"
"            <button onclick='sendChat()' id='sendBtn'>?ëó</button>"
"          </div>"
"        </div>"
"      </div>"
"    </div>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>Agent îzíu</span>"
"            <button class='btn btn-sm btn-primary' onclick='saveAgent()'>ï€ë∂</button>"
"          </div>"
"          <div class='form-group'>"
"            <label>SOUL.md (ê´äi?íË)</label>"
...
"          </div>"
"          <div class='form-group'>"
"            <label>HEARTBEAT.md (íË?îC?)</label>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>LLM îzíu</span>"
"            <button class='btn btn-sm btn-primary' onclick='saveSettings()'>ï€ë∂</button>"
"          </div>"
"          <div class='form-row'>"
"            <div class='form-group'>"
"              <label>íÒãüè§</label>"
...
"                <option value='ollama'>Ollama (ñ{ín)</option>"
"              </select>"
"            </div>"
"            <div class='form-group'>"
"              <label>‡“?ñÕå^</label>"
"              <input type='text' id='model' placeholder='î@: claude-opus-4-5'>"
"            </div>"
"          </div>"
"          <div class='form-row'>"
"            <div class='form-group'>"
...
"            <div class='form-group'>"
"              <label>Ollama éÂä˜</label>"
"              <input type='text' id='ollama_host' placeholder='î@: 192.168.1.100'>"
"            </div>"
"            <div class='form-group'>"
"              <label>Ollama í[å˚</label>"
"              <input type='text' id='ollama_port' placeholder='‡“?: 11434'>"
"            </div>"
"          </div>"
"          <div class='form-row'>"
...
"              <label for='streaming' style='margin:0'>?ópó¨éÆ?èo (Streaming)</label>"
"            </div>"
"          </div>"
"        </div>"
""
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>??ëÄçÏ</span>"
"          </div>"
"          <button class='btn btn-danger' onclick='reboot()'>èd???</button>"
"        </div>"
"      </div>"
...
""
"    <!-- Federation View -->"
"    <div class='view' id='view-federation'>"
"      <div class='content'>"
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>???ñM</span>"
"            <button class='btn btn-sm btn-primary' onclick='loadPeers()'>ç¸êVóÒï\</button>"
"          </div>"
"          <div id='peerList' style='font-size:13px;color:#ccc'>â¡?íÜ...</div>"
"        </div>"
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>åQ?õˆîd</span>"
"          </div>"
"          <div class='form-row'>"
"            <input type='text' id='broadcastCmd' placeholder='Command' style='flex:1;padding:8px;border-radius:4px;border:1px solid #ddd'>"
"            <input type='text' id='broadcastArgs' placeholder='Args JSON' style='flex:1;padding:8px;border-radius:4px;border:1px solid #ddd'>"
"            <button class='btn btn-primary' onclick='sendBroadcast()'>?ëó</button>"
"          </div>"
"        </div>"
"      </div>"
"    </div>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>?? „§?ùrçı (Brave)</span>"
"            <button class='btn btn-sm btn-primary' onclick='saveSearchKey()'>ï€ë∂</button>"
"          </div>"
"          <div class='form-group'>"
"            <label>Brave Search API Key</label>"
"            <input type='password' id='searchKey' placeholder='BSA-xxxx...'>"
"          </div>"
"          <div style='font-size:12px;color:#888;margin-top:4px'>ò∏ <a href='https://brave.com/search/api/' style='color:#6C9BD2' target='_blank'>brave.com/search/api</a> ?éÊñ∆? API Key</div>"
"        </div>"
""
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>? íË?îC?</span>"
"            <button class='btn btn-sm btn-primary' onclick='loadCronJobs()'>ç¸êV</button>"
"          </div>"
"          <div id='cronList' style='font-size:13px;color:#ccc'>â¡?íÜ...</div>"
"        </div>"
""
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>çHãÔèÛ?</span>"
"          </div>"
"          <div style='font-size:13px;color:#ccc;line-height:2'>"
"            <div>?? <b>?éÊ??</b>ÅFí ? SNTP é©?ìØ?ÅCùŸé˘îzíu</div>"
"            <div>?? <b>ï∂åèä«óù</b>ÅF? / é  / ?? / óÒèo SPIFFS ï∂åè</div>"
"          </div>"
"        </div>"
""
"      </div>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>à¯ãrîzíu</span>"
"            <button class='btn btn-sm btn-primary' onclick='savePinConfig()'>ï€ë∂îzíu</button>"
"          </div>"
...
"            </div>"
"            <div>"
"              <div style='font-size:13px;color:var(--text-secondary);margin-bottom:4px;'>I2S0 WS (îûçé?)</div>"
...
"            </div>"
"            <div>"
"              <div style='font-size:13px;color:var(--text-secondary);margin-bottom:4px;'>I2S0 SCK (îûçé?)</div>"
...
"            </div>"
"            <div>"
"              <div style='font-size:13px;color:var(--text-secondary);margin-bottom:4px;'>I2S0 SD (îûçé?)</div>"
...
"            </div>"
"            <div>"
"              <div style='font-size:13px;color:var(--text-secondary);margin-bottom:4px;'>I2S1 DIN (å˜ï˙)</div>"
...
"            </div>"
"            <div>"
"              <div style='font-size:13px;color:var(--text-secondary);margin-bottom:4px;'>I2S1 BCLK (å˜ï˙)</div>"
...
"            </div>"
"            <div>"
"              <div style='font-size:13px;color:var(--text-secondary);margin-bottom:4px;'>I2S1 LRC (å˜ï˙)</div>"
...
"            </div>"
"            <div>"
"              <div style='font-size:13px;color:var(--text-secondary);margin-bottom:4px;'>âπó ?à¬?</div>"
...
"            </div>"
"            <div>"
"              <div style='font-size:13px;color:var(--text-secondary);margin-bottom:4px;'>âπó â¡à¬?</div>"
...
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>çdåèèÛ?</span>"
"            <button class='btn btn-sm btn-primary' onclick='loadHardwareStatus()'>ç¸êV</button>"
"          </div>"
"          <div id='hw-status' style='font-size:13px;color:#ccc'>â¡?íÜ...</div>"
"        </div>"
""
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>I2C ???ï`</span>"
"            <button class='btn btn-sm btn-primary' onclick='scanI2C()'>?ï`</button>"
"          </div>"
"          <div id='i2c-result' style='font-size:13px;color:#ccc'>ì_??ï`...</div>"
"        </div>"
""
"        <div class='card'>"
"          <div class='card-header'>"
"            <span class='card-title'>GPIO çTêß</span>"
"          </div>"
...
"    </div>"
""
"    <!-- SkillHub View (Unified) -->"
"    <div class='view' id='view-skillhub'>"
"      <div class='content'>"
"        <!-- Main Tabs -->"
"        <div class='card' style='margin-bottom:16px;'>"
"          <div style='display:flex;gap:8px;'>"
"            <button id='hub-btn-market' class='btn btn-sm btn-primary' onclick='switchHubTab(\"market\")'>?ópés? (Mock)</button>"
"            <button id='hub-btn-installed' class='btn btn-sm' onclick='switchHubTab(\"installed\")'>õﬂà¿ëïä«óù</button>"
"            <button id='hub-btn-sources' class='btn btn-sm' onclick='switchHubTab(\"sources\")'>MCP åπ</button>"
"          </div>"
"        </div>"
"        <!-- Tab: Market (Original SkillHub) -->"
"        <div id='hub-content-market'>"
"          <div class='card'>"
"            <div style='display:flex;gap:12px;align-items:center;'>"
"              <input type='text' id='skillSearch' placeholder='ùrçı?ä¥äÌÅAë«ä˜ÅALED...' style='flex:1;padding:12px 16px;border:1px solid var(--border);border-radius:8px;font-size:14px;' oninput='filterSkills()'>"
"              <span id='slotInfo' style='font-size:13px;color:var(--text-secondary);white-space:nowrap;'>õﬂà¿ëï: 0/0</span>"
"            </div>"
"            <div style='display:flex;gap:8px;margin-top:12px'>"
"               <button id='tab-all' class='btn btn-sm btn-primary' onclick='switchSkillTab(\"all\")'>ëSïî</button>"
"               <button id='tab-hardware' class='btn btn-sm' onclick='switchSkillTab(\"hardware\")'>çdåè</button>"
"               <button id='tab-software' class='btn btn-sm' onclick='switchSkillTab(\"software\")'>?åè</button>"
"            </div>"
"          </div>"
"          <div id='skillsList'>"
"            <div style='text-align:center;color:var(--text-secondary);padding:40px;'>â¡?íÜ...</div>"
"          </div>"
"        </div>"
"        <!-- Tab: Installed (Original Installed View) -->"
"        <div id='hub-content-installed' style='display:none'>"
"          <div class='card'>"
"            <div class='card-header'>"
"              <span class='card-title'>õﬂà¿ëïãZî\</span>"
"              <button class='btn btn-sm' onclick='reloadSkills()'>?? èd?à¯˙Ã</button>"
"            </div>"
"            <div id='installedList'>"
"              <div style='text-align:center;color:var(--text-secondary);padding:20px;'>?ùŸõﬂà¿ëïãZî\</div>"
"            </div>"
"          </div>"
"        </div>"
"        <!-- Tab: Sources (Original MCP View) -->"
"        <div id='hub-content-sources' style='display:none'>"
"          <div class='card'>"
"            <div class='card-header'>"
"              <div style='display:flex;align-items:center;gap:12px'>"
"                <span class='card-title'>MCP Servers</span>"
"                <button class='btn btn-sm btn-primary' onclick='showAddMcpSourceModal()'>+ ìYâ¡åπ</button>"
"              </div>"
"              <button class='btn btn-sm' onclick='loadMcpSources()'>?? ç¸êV</button>"
"            </div>"
"            <div id='mcpSourceList' style='display:grid;gap:12px;grid-template-columns:repeat(auto-fit,minmax(300px,1fr))'>"
"              <div style='text-align:center;color:var(--text-secondary);padding:20px;'>â¡?íÜ...</div>"
"            </div>"
"          </div>"
"        </div>"
"      </div>"
...
"      const titles = { dashboard: '?ï\?', chat: '„÷ìV', agent: 'Agent', settings: '?íu', tools: 'çHãÔ', hardware: 'çdåè', skillhub: 'SkillHub', installed: 'õﬂà¿ëïãZî\', federation: '?ñM' };\n"
...
"        grid.innerHTML = '';"
"        const items = ["
"          { label: 'WiFi IP', value: data.wifi_ip || 'ñ¢?ê⁄' },"
"          { label: 'LLM íÒãüè§', value: data.provider || 'ñ¢ím' },"
"          { label: 'ñÕå^', value: data.model || 'ñ¢?íu' },"
"          { label: '?çs??', value: formatUptime(data.uptime_ms) },"
"        ];"
"        items.forEach(item => {"
"          grid.innerHTML += '<div class=\\'status-item\\'><div class=\\'status-label\\'>' + item.label + '</div><div class=\\'status-value\\'>' + item.value + '</div></div>';"
"        });"
"        document.getElementById('ipBadge').textContent = data.wifi_ip || 'ùŸ„§?';"
"      } catch(e) { showToast('?éÊèÛ?é∏?', 'error'); }"
"    }"
""
...
"      if (h > 0) return h + 'è¨? ' + (m % 60) + 'ï™?';"
"      if (m > 0) return m + 'ï™? ' + (s % 60) + 'ïb';"
"      return s + 'ïb';"
"    }"
""
"    /* Settings */"
...
"        });"
"        if (resp.ok) { showToast('îzíuõﬂï€ë∂', 'success'); }"
"        else { showToast('ï€ë∂é∏?', 'error'); }"
"      } catch(e) { showToast('ï€ë∂é∏?: ' + e, 'error'); }"
"    }"
""
"    async function reboot() {"
"      if (!confirm('?íËóvèd????ÅH')) return;"
"      try {"
"        await fetch('/api/reboot', {method: 'POST'});"
"        showToast('ê≥ç›èd?...', 'warning');"
"      } catch(e) { showToast('èd?é∏?', 'error'); }"
"    }"
""
...
"      if (pending > 0) {"
"        btn.textContent = 'évçlíÜ(' + pending + ')';"
"      } else {"
"        btn.textContent = '?ëó';"
"      }"
"    }"
...
"        document.getElementById('wsText').textContent = 'õﬂ?ê⁄';"
"      };"
""
...
"        document.getElementById('wsText').textContent = 'èd?íÜ...';"
"        pending = 0; updateSendBtn();"
"        setTimeout(connectWS, 3000);"
"      };"
""
"      ws.onerror = function() {"
"        document.getElementById('wsText').textContent = '?ê⁄??';"
"      };"
"    }"
""
...
"           div.innerHTML = '<div class=\"markdown-body\">' + marked.parse(content) + '</div>';"
...
"               btn.onclick = () => copyToClipboard(code.innerText, btn);"
"               pre.appendChild(btn);"
"           });"
"        } else {"
...
""
"    function sendChat() {"
"      if (!connected) { showToast('ñ¢?ê⁄ìû??', 'error'); return; }"
...
"      pendingTimer = setTimeout(function() { pending = 0; updateSendBtn(); addChatMessage('error', '??í¥?ÅC?èd?'); }, 300000);"
""
...
"          list.innerHTML = '<div style=\"padding:10px;text-align:center\">?ùŸ??ë¥ëº??</div>';"
"          return;"
"        }"
"        list.innerHTML = '';"
...
"            <div>"
"              <div style=\"font-weight:bold;font-size:14px\">${p.hostname}</div>"
"              <div style=\"font-size:12px;color:#666\">${p.ip}:${p.port} <span style=\"background:#eee;padding:2px 4px;border-radius:4px\">Group: ${p.group||'default'}</span></div>"
"            </div>"
"            <div style=\"font-size:12px;color:#888\">${Math.floor(p.last_seen_ago)}s ago</div>"
"          </div>`;"
"        });"
"      } catch(e) { console.error(e); }"
"    }"
...
"      const args = document.getElementById('broadcastArgs').value || '{}';"
"      if (!cmd) return;"
"      try {"
"        await fetch('/api/federation/command', {"
"          method: 'POST',"
"          headers: {'Content-Type': 'application/json'},"
"          body: JSON.stringify({ command: cmd, args: JSON.parse(args) })"
"        });"
"        showToast('õˆîdñΩóﬂõﬂ?ëó', 'success');"
"      } catch(e) { showToast('?ëóé∏?', 'error'); }"
"    }"
""
"    /* Agent */"
...
"        });"
"        if (resp.ok) { showToast('Agent îzíuõﬂï€ë∂', 'success'); }"
"        else { showToast('ï€ë∂é∏?', 'error'); }"
"      } catch(e) { showToast('ï€ë∂é∏?: ' + e, 'error'); }"
"    }"
""
...
"      if (!key) { showToast('??ì¸ API Key', 'error'); return; }"
"      try {"
"        const resp = await fetch('/api/tools/search_key', {"
"          method: 'POST',"
"          headers: {'Content-Type': 'application/json'},"
...
"        });"
"        if (resp.ok) { showToast('ùrçı Key õﬂï€ë∂', 'success'); }"
"        else { showToast('ï€ë∂é∏?', 'error'); }"
"      } catch(e) { showToast('ï€ë∂é∏?: ' + e, 'error'); }"
"    }"
""
...
"          el.innerHTML = '<div style=\"color:#888\">ñvóLäà?ìIíË?îC?</div>';\n"
"          return;\n"
"        }\n"
"        let html = '';\n"
"        data.jobs.forEach(function(j) {\n"
"          var sched = j.kind === 'every' ? '? ' + j.interval_s + ' ïb' : 'ç› ' + new Date(j.at_epoch * 1000).toLocaleString();\n"
...
"          html += '<div><b>' + j.name + '</b><br><span style=\"font-size:11px;color:#888\">' + sched + ' | ' + (j.enabled ? '? ?óp' : '? ã÷óp') + ' | ID: ' + j.id + '</span></div>';\n"
"          html += '<button class=\"btn btn-sm btn-danger\" onclick=\\'deleteCronJob(\"' + j.id + '\")\\'>?èú</button>';\n"
"          html += '</div>';\n"
"        });\n"
"        el.innerHTML = html;\n"
"      } catch(e) { document.getElementById('cronList').innerHTML = 'â¡?é∏?'; }\n"
"    }\n"
""
""
"    /* MCP Manager */\n"
...
"      try {\n"
"        const resp = await fetch('/api/mcp/sources');\n"
"        const data = await resp.json();\n"
"        const el = document.getElementById('mcpSourceList');\n"
"        if (!data.sources || data.sources.length === 0) {\n"
"           el.innerHTML = '<div style=\"grid-column:1/-1;text-align:center;color:#888;padding:20px\">?ùŸ MCP åπ</div>';\n"
"           return;\n"
"        }\n"
"        let html = '';\n"
"        data.sources.forEach(s => {\n"
"           const statusColor = s.status === 'connected' ? 'var(--success)' : '#94a3b8';\n"
"           const statusText = s.status === 'connected' ? 'õﬂ?ê⁄' : 'ñ¢?ê⁄';\n"
"           html += `<div class='card'>`;\n"
"           html += `  <div style='display:flex;justify-content:space-between;align-items:start;margin-bottom:8px'>`;\n"
"           html += `    <div style='font-weight:600;font-size:15px'>${s.name}</div>`;\n"
"           html += `    <div style='font-size:12px;padding:2px 8px;border-radius:12px;background:${statusColor}20;color:${statusColor}'>${statusText}</div>`;\n"
"           html += `  </div>`;\n"
"           html += `  <div style='font-size:12px;color:var(--text-secondary);margin-bottom:12px'>${s.url}</div>`;\n"
"           html += `  <div style='display:flex;gap:8px'>`;\n"
"           if (s.status !== 'connected') {\n"
"               html += `<button class='btn btn-sm btn-primary' onclick='mcpAction(${s.id}, \"connect\")'>?ê⁄</button>`;\n"
"           } else {\n"
"               html += `<button class='btn btn-sm' onclick='mcpAction(${s.id}, \"disconnect\")'>íf?</button>`;\n"
"           }\n"
"           // html += `<button class='btn btn-sm btn-danger' onclick='deleteMcpSource(${s.id})'>?èú</button>`; // TODO\n"
"           html += `  </div>`;\n"
"           html += `</div>`;\n"
"        });\n"
"        el.innerHTML = html;\n"
"      } catch(e) { document.getElementById('mcpSourceList').textContent = 'â¡?é∏?: ' + e; }\n"
"    }\n"
""
""
"    async function mcpAction(id, action) {\n"
"        try {\n"
"            const resp = await fetch('/api/mcp/sources/action', {\n"
"                method: 'POST',\n"
"                headers: {'Content-Type': 'application/json'},\n"
"                body: JSON.stringify({id: id, action: action})\n"
"            });\n"
"            if (resp.ok) { showToast('ëÄçÏê¨å˜', 'success'); loadMcpSources(); }\n"
"            else { showToast('ëÄçÏé∏?', 'error'); }\n"
"        } catch(e) { showToast('?ãÅé∏?', 'error'); }\n"
"    }\n"
""
""
"    async function showAddMcpSourceModal() {\n"
"        const name = prompt('Server Name:');\n"
"        if (!name) return;\n"
"        const url = prompt('WebSocket URL (ws://...):', 'ws://192.168.1.50:8080/mcp');\n"
"        if (!url) return;\n"
"        try {\n"
"             const resp = await fetch('/api/mcp/sources/add', {\n"
"                 method: 'POST',\n"
"                 headers: {'Content-Type': 'application/json'},\n"
"                 body: JSON.stringify({name: name, url: url, transport: 'websocket'})\n"
"             });\n"
"             if (resp.ok) { showToast('ìYâ¡ê¨å˜', 'success'); loadMcpSources(); }\n"
"             else { showToast('ìYâ¡é∏?', 'error'); }\n"
"        } catch(e) { showToast('?ãÅé∏?', 'error'); }\n"
"    }\n"
""
""
"    async function deleteCronJob(id) {\n"
"      if (!confirm('?íË?èúîC? ' + id + ' ?ÅH')) return;\n"
"      try {\n"
"        const resp = await fetch('/api/tools/cron?id=' + id, { method: 'DELETE' });\n"
"        if (resp.ok) { showToast('õﬂ?èú', 'success'); loadCronJobs(); }\n"
"        else { showToast('?èúé∏?', 'error'); }\n"
"      } catch(e) { showToast('?èúé∏?: ' + e, 'error'); }\n"
"    }\n"
""
...
"        html += '<div><span style=\"color:#666\">Temp:</span> ' + data.cpu_temp_c.toFixed(1) + ' ÅãC</div>';\n"
...
"        html += '<div style=\"grid-column:span 2;margin-top:8px;padding-top:8px;border-top:1px solid #eee;\"><strong>ì‡ë∂:</strong></div>';\n"
...
"        html += '<div><span style=\"color:#666\">ì‡ïî:</span> ' + (data.free_heap_internal/1024).toFixed(1) + ' KB / ' + (data.total_heap_internal/1024).toFixed(0) + ' KB (' + intPct.toFixed(0) + '% used)</div>';\n"
...
"        html += '<div><span style=\"color:#666\">ç≈ëÂ?:</span> ' + (data.largest_free_block/1024).toFixed(1) + ' KB</div>';\n"
"        html += '<div><span style=\"color:#666\">ç≈è¨ãÛ?:</span> ' + (data.min_free_heap/1024).toFixed(1) + ' KB</div>';\n"
"        html += '</div>';\n"
...
"        if (data.success) {\n"
"          st.textContent = 'îzíuõﬂï€ë∂ÅCé˘óvèd?ê∂ù¡';\n"
"          st.style.color = 'var(--success)';\n"
"          showToast('à¯ãrîzíuõﬂï€ë∂', 'success');\n"
"        } else {\n"
"          st.textContent = 'ï€ë∂é∏?';\n"
"          st.style.color = 'var(--error)';\n"
"        }\n"
"      } catch(e) {\n"
"        document.getElementById('pin-config-status').textContent = 'ï€ë∂é∏?: ' + e.message;\n"
"      }\n"
"    }\n"
""
""
...
"        // /api/skills returns currently installed skills in runtime.\n"
"        installedSkills = new Set(allSkills.map(s => s.name));\n"
"        renderSkills(allSkills);\n"
"        updateSlotInfo();\n"
"      } catch(e) {\n"
"        document.getElementById('skillsList').innerHTML = '<div style=\"text-align:center;color:var(--error);padding:40px;\">â¡?é∏?: ' + e.message + '</div>';\n"
"      }\n"
"    }\n"
""
""
...
""
"        // Category filter\n"
"        if (currentSkillTab === 'all' || currentSkillTab === 'installed_view') return matchesSearch;\n"
"        const category = (s.category || 'UNKNOWN').toUpperCase();\n"
"        if (currentSkillTab === 'hardware') return matchesSearch && (category === 'SENSOR' || category === 'ACTUATOR');\n"
"        if (currentSkillTab === 'software') return matchesSearch && (category === 'PROTOCOL' || category === 'UTILITY' || category === 'SYSTEM');\n"
"        return matchesSearch;\n"
"      });\n"
""
""
"      if (filtered.length === 0) {\n"
"        container.innerHTML = '<div style=\"text-align:center;color:var(--text-secondary);padding:40px;\">?ùŸãZî\</div>';\n"
"        return;\n"
"      }\n"
""
""
...
"        const bus = skill.bus || 'NONE';\n"
"        const catBg = category === 'SENSOR' ? '#dbeafe' : (category === 'ACTUATOR' ? '#ffedd5' : '#f1f5f9');\n"
"        const catText = category === 'SENSOR' ? '#1e40af' : (category === 'ACTUATOR' ? '#9a3412' : '#475569');\n"
""
""
...
"        html += `        <span style='font-weight:600;font-size:16px;'>${escapeHtml(skill.name)}</span>`;\n"
...
"        html += `        <span style='background:${catBg};color:${catText};padding:2px 8px;border-radius:12px;font-size:11px;font-weight:600'>${category}</span>`;\n"
"        html += `        <span style='border:1px solid var(--border);padding:1px 6px;border-radius:4px;font-size:11px;color:var(--text-secondary);'>${type}</span>`;\n"
"        if (bus !== 'NONE') html += `        <span style='background:#f3f4f6;color:#374151;padding:2px 6px;border-radius:4px;font-size:11px;font-family:monospace'>${bus}</span>`;\n"
"        html += `      </div>`;\n"
"        html += `      <div style='font-size:13px;color:var(--text-secondary);margin-bottom:8px;'>`;\n"
"        html += `        Author: ${escapeHtml(author)}`;\n"
"        html += `      </div>`;\n"
"        if (skill.description) {\n"
"            html += `      <div style='font-size:13px;color:var(--text);line-height:1.4'>${escapeHtml(skill.description)}</div>`;\n"
"        }\n"
"        html += `    </div>`;\n"
"        html += `    <div style='display:flex;gap:8px;margin-left:12px'>`;\n"
"        if (currentSkillTab === 'installed_view') {\n"
"             html += `      <button class='btn btn-sm btn-danger' onclick='uninstallSkill(\"${escapeHtml(skill.name)}\")'>âµ?</button>`;\n"
"        } else {\n"
"             if (isInstalled) {\n"
"                html += `      <button class='btn btn-sm' style='background:var(--success);color:white;opacity:0.8' disabled>õﬂà¿ëï</button>`;\n"
"             } else {\n"
"                html += `      <button class='btn btn-sm btn-primary' onclick='installSkill(\"${escapeHtml(skill.name)}\", \"${escapeHtml(skill.url || '')}\")'>à¿ëï</button>`;\n"
"             }\n"
"             html += `      <button class='btn btn-sm' onclick='showSkillDetails(\"${escapeHtml(skill.name)}\")'>?èÓ</button>`;\n"
"        }\n"
"        html += `    </div>`;\n"
"        html += `  </div>`;\n"
"        html += `</div>`;\n"
...
"      document.getElementById('slotInfo').textContent = `õﬂà¿ëï: ${count}/${MAX_SLOTS} ?ëÖ`;\n"
"    }\n"
""
""
"    async function installSkill(name, url) {\n"
"      if (!url) {\n"
"        showToast('?ãZî\?ùŸâ¬ópà¿ëïåπ', 'warning');\n"
"        return;\n"
"      }\n"
"      try {\n"
"        showToast('ê≥ç›à¿ëï ' + name + '...', 'success');\n"
...
"        const data = await resp.json();\n"
"        if (data.success) {\n"
"          showToast(name + ' à¿ëïê¨å˜!', 'success');\n"
"          await loadSkills();\n"
"        } else {\n"
"          showToast('à¿ëïé∏?: ' + (data.error || 'ñ¢ím??'), 'error');\n"
"        }\n"
"      } catch(e) {\n"
"        showToast('à¿ëï?ãÅé∏?: ' + e.message, 'error');\n"
"      }\n"
"    }\n"
""
""
"    async function uninstallSkill(name) {\n"
"      if (!confirm('?íËóvâµ? ' + name + ' ??')) return;\n"
"      try {\n"
...
"          showToast(name + ' õﬂâµ?', 'success');\n"
"          await loadSkills();\n"
"        } else {\n"
"          showToast('âµ?é∏?: ' + (data.error || 'ñ¢ím??'), 'error');\n"
"        }\n"
"      } catch(e) {\n"
"        showToast('âµ??ãÅé∏?: ' + e.message, 'error');\n"
"      }\n"
"    }\n"
""
""
"    async function reloadSkills() {\n"
"      if (!confirm('?íËóvèd?ãZî\à¯˙Ã??')) return;\n"
"      try {\n"
"        const resp = await fetch('/api/skills/reload', { method: 'POST' });\n"
"        if (resp.ok) {\n"
"          showToast('ãZî\à¯˙Ãõﬂèd?', 'success');\n"
"          await loadSkills();\n"
"        } else {\n"
"          showToast('èd?é∏?', 'error');\n"
"        }\n"
"      } catch(e) {\n"
"        showToast('èd??ãÅé∏?: ' + e.message, 'error');\n"
"      }\n"
"    }\n"
""
""
...
"      if (!skill) return;\n"
"      let details = 'ñºèÃ: ' + skill.name + '\\n';\n"
"      details += 'î≈ñ{: ' + (skill.version || 'ñ¢ím') + '\\n';\n"
"      details += 'çÏé“: ' + (skill.author || 'ñ¢ím') + '\\n';\n"
"      details += 'ï`èq: ' + (skill.description || 'ùŸ');\n"
"      alert(details);\n"
"    }\n"
""
""
...
"      } catch(e) {\n"
"        document.getElementById('installedList').innerHTML = '<div style=\"text-align:center;color:var(--error);padding:20px;\">â¡?é∏?: ' + e.message + '</div>';\n"
"      }\n"
"    }\n"
""
""
...
"      if (skills.length === 0) {\n"
"        container.innerHTML = '<div style=\"text-align:center;color:var(--text-secondary);padding:20px;\">?ùŸõﬂà¿ëïãZî\</div>';\n"
"        return;\n"
"      }\n"
""
""
...
"        const version = skill.version || '1.0';\n"
"        const author = skill.author || '@unknown';\n"
"        const state = normalizeSkillState(skill.state);\n"
"        const stateColor = state === 'READY' ? 'var(--success)' : (state === 'ERROR' ? 'var(--error)' : 'var(--warning)');\n"
"        const stateText = state === 'READY' ? '?çsíÜ' : (state === 'ERROR' ? '?èÌ' : 'õﬂí‚é~');\n"
"        const category = skill.category || 'UNKNOWN';\n"
"        const type = skill.type || 'TOOL';\n"
"        const bus = skill.bus || 'NONE';\n"
"        const busType = bus !== 'NONE' ? bus : '-';\n"
"        const categoryIcon = category === 'SENSOR' ? '??' : '??';\n"
""
""
"        html += `<div class='card' style='margin-bottom:12px;'>`;\n"
...
"        html += `      <div>`;\n"
"        html += `        <div style='font-weight:600;font-size:15px;'>${escapeHtml(skill.name)} <span style='color:var(--text-secondary);font-weight:normal;'>v${escapeHtml(version)}</span>`;\n"
"        html += `          <span style='border:1px solid var(--border);padding:0px 4px;border-radius:3px;font-size:10px;margin-left:6px'>${type}</span>`;\n"
"        html += `        </div>`;\n"
"        html += `        <div style='font-size:12px;color:var(--text-secondary);'>Author: ${escapeHtml(author)} | Bus: ${busType} | ${category}</div>`;\n"
"        html += `      </div>`;\n"
"        html += `    </div>`;\n"
"        html += `    <div style='display:flex;align-items:center;gap:12px;'>`;\n"
...
"    /* Unified SkillHub Tabs */\n"
"    function switchHubTab(tab) {\n"
"        // Toggle Buttons\n"
"        ['market', 'installed', 'sources'].forEach(t => {\n"
"            const btn = document.getElementById('hub-btn-' + t);\n"
"            if (btn) btn.className = (t === tab) ? 'btn btn-sm btn-primary' : 'btn btn-sm';\n"
""
""
...
""
""
"    // Override switchView to default to SkillHub->Market\n"
...
/* ÑüÑü HTTP Handlers ÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑü */
...
/* ÑüÑü Agent file helpers ÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑü */
...
static esp_err_t agent_get_handler(httpd_req_t *req)
{
    ...
    json_escape(fbuf, ebuf, 8192);
    off += snprintf(resp + off, 40960 - off, "  \"heartbeat\": \"%s\"", ebuf);
...
/* ÑüÑü Tools API handlers ÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑü */
...
/* ÑüÑü OTA / Firmware API handlers ÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑü */
...
/* ÑüÑü MCP Manager API ÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑü */
...
/* ÑüÑü Server Init ÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑüÑü */
