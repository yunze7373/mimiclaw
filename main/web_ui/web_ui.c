...
"             h += `<button id=\"btn-gpio-${item.p}-off\" onclick=\"toggleGPIO(${item.p}, false)\" class=\"btn btn-xs btn-outline-secondary\" style=\"margin-left:2px;opacity:0.3\">OFF</button>`;\n"
"             h += `</div>`;\n"
"          } else {\n"
"             h += `<span class=\"badge-warn\">RESTRICTED</span>`;\n"
"          }\n"
"          h += `</div>`;\n"
"          return h;\n"
"      };\n"
...
"      html += '<div class=\"board-col\"><h4>Left Header</h4>';\n"
"      left.forEach(i => html += renderPin(i));\n"
"      html += '</div><div class=\"board-col\"><h4>Right Header</h4>';\n"
