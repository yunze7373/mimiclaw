...
"      </div>"
"      <div class='nav-item' data-view='installed'>"
"        <span class='nav-icon'>🧩</span>"
"        <span class='nav-label'>已安装</span>"
"      </div>"
...
"      const titles = { dashboard: '仪表盘', chat: '聊天', agent: 'Agent', settings: '设置', tools: '工具', hardware: '硬件', skillhub: 'SkillHub', installed: '已安装技能' };\n"
